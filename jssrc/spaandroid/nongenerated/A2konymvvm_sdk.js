...
kony.sdk.mvvm.View = Class({
    constructor: function(modelConfig) {
        ...
        function createWidgetControllers() {
            ...
            var widgets = scopeObj.modelConfig.getAllWidgets();
                ...
                if (scopeObj.konyform[widgetId] !== null) {
                    ...
                    switch (widgetType.toLowerCase().trim()) {
                        ...
                        case "radiobuttongroup":
                            defaultWidgetControllerName = "RadioButtonGroupWidgetController";
                            widgetcontrollername = widgetControllerName === undefined || widgetControllerName === null || widgetControllerName === "" ? defaultWidgetControllerName : widgetControllerName;
                            break;
                        default:
                    ...
                    switch (widgetType) {
                        ...
                        case "radiobuttongroup":
                            ...
                            scopeObj.konyWidgetObjects[widgetId] = controller;
                            kony.sdk.mvvm.log.info("listbox/combobox/radiobuttongroup widget controller creation success ");
                            break;
                        case "segment":
                            var controller = new controllerHandler(scopeObj, konyWidget, widgets[widgetId]);
                            if (controller.$class.$super !== kony.sdk.mvvm.WidgetController && controller.$class !== kony.sdk.mvvm.WidgetController) {
        ...
        try {
            ...
            switch (this.getWidgetType()) {
                ...
                case "image":
                    ...
                    break;
                case "calendar":
                    konyWidget.dateComponents = data.getData();
                    break;
                case "switch":
...
kony.sdk.mvvm.SegmentWidgetController = Class(kony.sdk.mvvm.WidgetController, {
    ...
    clear: function() {
        try {
            ...
            if (this.getWidgetConfig().getWidgetDataMap() && Object.keys(this.getWidgetConfig().getWidgetDataMap()).length > 0) this.getKonyWidget().widgetDataMap = this.getWidgetConfig().getWidgetDataMap()
        } catch (err) {
...
kony.sdk.mvvm.RadioButtonGroupWidgetController = Class(kony.sdk.mvvm.WidgetController, {
    constructor: function(viewObj, konyWidget, widgetConfig) {
        this.$class.$super.call(this, viewObj, konyWidget, widgetConfig)
    },
    destroy: function() {
    ...
    setDataToWidget: function(data) {
        try {
            ...
            kony.sdk.mvvm.log.error("error in setDataToWidget for radiobuttongroup " + err.toString());
            throw err
        }
    },
    getDataFromWidget: function() {
        try {
            ...
            kony.sdk.mvvm.log.error("error in getData from widget for radiobuttongroup " + err.toString());
            throw err
        }
    },
    getKonyWidget: function() {
    ...
    isValueChanged: function(data) {
        try {
            ...
            kony.sdk.mvvm.log.error("error in isvalueChanged for radiobuttongroup " + err.toString());
            throw err
        }
    },
    setMasterDataToWidget: function(masterData) {
        try {
            ...
            kony.sdk.mvvm.log.error("Error in setting master data to widget for radiobuttongroup " + err.toString());
            throw err
        }
    },
    getMasterDataFromWidget: function() {
...
kony.sdk.mvvm.ConfigClass = Class({
    constructor: function(modelConfig) {
        ...
        var events = {};
        var widgets = {};
        var customVerbDefinedWidgets = {};
        var containerAndCustomVerbMap = {};
        var serviceOptionsMap = {};
        var objectServiceMap = {};
        ...
        var customVerb = undefined;
        var widgetListType = undefined;
        var appFactoryInstance = kony.sdk.mvvm.KonyApplicationContext.getFactorySharedInstance();
        ...
        try {
            ...
            this.getWidgets = function() {
                if (widgetListType == "customVerb") return customVerbDefinedWidgets;
                else return widgets
            };
            this.getAllWidgets = function() {
                return kony.sdk.mvvm.Util.mergeJSONs(customVerbDefinedWidgets, widgets)
            };
            ...
            this.getAllWidgetsHierarchyMap = function() {
                var allWidgets = kony.sdk.mvvm.Util.mergeJSONs(customVerbDefinedWidgets, widgets);
                return this.getWidgetHierarchyMap(allWidgets)
            };
            this.getServiceOptions = function(widgetId) {
                if (serviceOptionsMap[widgetId]) return serviceOptionsMap[widgetId];
                return this.getObjectServiceOptions()
            };
            this.getCustomInfo = function(key) {
            ...
            this.getObjectServiceNameOfContainer = function(containerId) {
                if (objectServiceMap[containerId]) return objectServiceMap[containerId];
                return this.getObjectServiceName()
            };
            this.getRequestOptions = function() {
                return requestOptions
            };
            this.changeWidgetListCriteria = function(criteria) {
                widgetListType = criteria
            };
            ...
            this.getCustomVerb = function(widgetid) {
                return containerAndCustomVerbMap[widgetid]
            };
            ...
            customVerb = modelConfig[this.getFormId()]["customVerb"];
            ...
            for (var widgetid in modelConfig) {
                if (!(widgetid == "formid" || widgetid == this.getFormId())) {
                    ...
                    if (modelConfig[widgetid]["fieldprops"] && modelConfig[widgetid]["fieldprops"]["customVerb"]) {
                        customVerbDefinedWidgets[widgetid] = widgetconfig;
                        containerAndCustomVerbMap[widgetid] = modelConfig[widgetid]["fieldprops"]["customVerb"]
                    } else widgets[widgetid] = widgetconfig;
                    serviceOptionsMap[widgetid] = modelConfig[widgetid]["fieldprops"]["serviceOptions"];
                    objectServiceMap[widgetid] = modelConfig[widgetid]["fieldprops"]["objectServiceName"]
                }
            }
    ...
    getMasterDataEnabledWidgets: function() {
        ...
        for (var widget in widgets) {
            ...
            if (widgetType && (widgetType.toLowerCase() === "combobox" || widgetType.toLowerCase() === "listbox" || widgetType.toLowerCase() === "radiobuttongroup")) {
    ...
    getWidgetHierarchyMap: function(widgets) {
        try {
            if (!widgets) widgets = this.getWidgets();
...
kony.sdk.mvvm.KonyApplicationContext = Class(function() {
    ...
    return {
        $statics: {
            ...
            getObjectServiceNameOfEntity: function(entity) {
                return getApplicationContextImpl().getObjectServiceNameOfEntity(entity)
            },
            refreshApp: function() {
...
kony.sdk.mvvm.KonyApplicationContextMFAPP = Class(function() {
    ...
    return {
        $statics: {
            ...
            getObjectService: function(options, objectServiceName) {
                try {
                    ...
                    if (options.hasOwnProperty("mock") && options["mock"] == true) {
                        ...
                        kony.sdk.mvvm.log.info("Getting SDK ObjectService");
            ...
            getObjectServiceNameOfEntity: function(entity) {
                return this.getMetadataStore().getObjectServiceName(entity)
            },
            refreshApp: function() {
                var scopeObj = this;
...
kony.sdk.mvvm.AuthenticationManager = Class(kony.sdk.mvvm.BaseAuthenticationServiceManager, {
    ...
    authenticate: function(params, successCallback, errorCallback) {
        try {
            ...
            kony.sdk.mvvm.log.error("Error while authentication: " + e.toString());
        ...
        function authenticateService() {
            kony.sdk.mvvm.log.info("Getting SDK IdentityService");
            ...
            kony.sdk.mvvm.log.info("Making SDK login Call");
            identityClient.login(authParams, authSuccess, authError)
        }

        function authSuccess() {
            kony.sdk.mvvm.log.info("SDK login Success");
        ...
        function authError(err) {
            kony.sdk.mvvm.log.error("SDK login Failed " + err);
...
kony.sdk.mvvm.BaseFormController = Class({
    ...
    invokeCustomVerb: function(readDataFromForm, successCallback, errorCallback) {
        try {
            if (this.getControllerExtensionObject()) {
                this.getControllerExtensionObject().invokeCustomVerb(readDataFromForm, successCallback, errorCallback)
            }
        } catch (err) {
            kony.sdk.mvvm.log.error("Error in controller invoke custom verb ", err);
            throw this.getApplicationContext().getFactorySharedInstance().createExceptionObject(kony.sdk.mvvm.ExceptionCode.CD_ERROR_CUSTOMVERB, kony.sdk.mvvm.ExceptionCode.MSG_ERROR_CUSTOMVERB, err)
        }
    },
...
kony.sdk.mvvm.BaseFormControllerExtension = Class({
    constructor: function(controllerObj) {
        ...
        var onlineWidgetContext = undefined;
        var offlineWidgetContext = undefined;
        var containerRecords = {};
        var formWidgetsData = {};
        this.getController = function() {
            return controller
        };
        this.setController = function(newControllerObj) {
        ...
        this.getGroupWidgetsContext = function(widgetId) {
            var isOnline = function() {
                var configOptions = controller.getConfig().getServiceOptions(widgetId);
            ...
            var appFactoryInstance = controller.getApplicationContext().getFactorySharedInstance();
            if (isOnline()) {
                return this.getGroupWidgetsContextOnline()
            } else {
                return this.getGroupWidgetsContextOffline()
            }
        };
        this.resetWidgetContexts = function() {
            ORMController = undefined;
            groupWidgetsContext = undefined;
            onlineWidgetContext = undefined;
            offlineWidgetContext = undefined
        };
        this.getGroupWidgetsContextOnline = function() {
            var appFactoryInstance = controller.getApplicationContext().getFactorySharedInstance();
            if (!onlineWidgetContext) onlineWidgetContext = appFactoryInstance.createGroupWidgetsContextOnline(controller.getConfig(), controller.getContextData());
            return onlineWidgetContext
        };
        this.getGroupWidgetsContextOffline = function() {
            var appFactoryInstance = controller.getApplicationContext().getFactorySharedInstance();
            if (!offlineWidgetContext) offlineWidgetContext = appFactoryInstance.createGroupWidgetsContextOffline(controller.getConfig(), controller.getContextData());
            return offlineWidgetContext
        };
        ...
        this.createGroupWidgetsContext = function(widgetId) {
            var isOnline = function() {
                var configOptions = controller.getConfig().getServiceOptions(widgetId);
                if (configOptions && configOptions.hasOwnProperty("access") && configOptions.access === "offline") {
                    return false
            ...
            var appFactoryInstance = controller.getApplicationContext().getFactorySharedInstance();
            if (isOnline()) {
                onlineWidgetContext = appFactoryInstance.createGroupWidgetsContextOnline(controller.getConfig(), controller.getContextData());
                return onlineWidgetContext
            } else {
                offlineWidgetContext = appFactoryInstance.createGroupWidgetsContextOffline(controller.getConfig(), controller.getContextData());
                return offlineWidgetContext
            }
        };
        this.getRecordsDataMap = function(isDelete) {
            try {
                ...
                function setDataFromSegment(widget) {
                    ...
                    var serviceName = config.getObjectServiceNameOfContainer(widget.getWidgetId());
                    var options = config.getServiceOptions(widget.getWidgetId());
                ...
                function prepareRecordsDataMap(entityDef) {
                    ...
                    for (var containerName in entityDef) {
                        ...
                        var customVerb = configObj.getCustomVerb(containerName);
                        ...
                        var recordObject = new kony.sdk.mvvm.persistent.Record(entityName);
                        recordObject.setInfo("serviceName", configObj.getObjectServiceNameOfContainer(containerName));
                        recordObject.setInfo("options", configObj.getServiceOptions(containerName));
                        if (customVerb) recordObject.setInfo("customVerb", customVerb);
                        var modelObj = scopeObj.getController().getModel(entityName, configObj.getObjectServiceNameOfContainer(containerName), configObj.getServiceOptions(containerName));
    ...
    refreshConfig: function(newConfig) {
        var appContext = kony.sdk.mvvm.KonyApplicationContext.getAppInstance();
        var configObj = appContext.getFactorySharedInstance().createConfigClassObject(newConfig);
        var controllerObj = this.getController();
        controllerObj.setConfig(configObj);
        this.setController(controllerObj);
        var formName = configObj.getFormId();
    ...
    fetchData: function(successCallback, errorCallback) {
        try {
            ...
            function fetchDataForWidgetGroup() {
                ...
                if (scopeObj.isWidgetOnline(groupWidgets[indx])) scopeObj.getGroupWidgetsContextOnline().fetchDataForGroupWidget(groupWidgets[indx], sucCallback, errCallback);
                else scopeObj.getGroupWidgetsContextOffline().fetchDataForGroupWidget(groupWidgets[indx], sucCallback, errCallback);
    ...
    processData: function(data) {
        var widgetHierarchyMap = this.getController().getConfig().getAllWidgetsHierarchyMap();
        var appFactoryInstance = this.getController().getApplicationContext().getFactorySharedInstance();
        var groupWidgetContext = appFactoryInstance.createGroupWidgetsContextCommon(this.getController().getConfig(), this.getController().getContextData());
        groupWidgetContext.generateContextForWidgets(widgetHierarchyMap);
        if (data instanceof Array) {
            var groupWidgets = groupWidgetContext.getFetchWidgetList() || [];
            var result = {};
        ...
        for (var widgetGroupId in data) {
            var widgetContext = groupWidgetContext.getWidgetContext(widgetGroupId);
    ...
    saveData: function(successCallback, errorCallback) {
        try {
            ...
            if (dataMaplen >= 1) {
                scopeObj.saveRecords(recordsDataMap, sucCallback, errCallback)
            } else {
                return
            }
    ...
    deleteData: function(successCallback, errorCallback) {
        try {
            ...
            var dataMaplen = recordsDataMap.length;
            if (dataMaplen >= 1) {
                scopeObj.removeRecords(recordsDataMap, sucCallback, errCallback)
            } else {
                return
            }
    ...
    saveRecord: function(record, successCallback, errorCallback) {
        try {
            var scopeObj = this;
            if (record.getInfo("options")["access"] == "online") this.getGroupWidgetsContextOnline().saveRecord(record, sucCallback, errCallback);
            else this.getGroupWidgetsContextOffline().saveRecord(record, sucCallback, errCallback);
    ...
    saveRecords: function(records, successCallback, errorCallback) {
        try {
            ...
            var offlineRecords = [];
            for (i in records) {
                if (records[i].getInfo("options")["access"] == "online") onlineRecords.push(records[i]);
                else offlineRecords.push(records[i])
            }

            function onlineSave() {
                if (onlineRecords.length) scopeObj.getGroupWidgetsContextOnline().saveRecords(onlineRecords, offlineSave, errCallback);
                else offlineSave()
            }

            function offlineSave(response) {
                if (offlineRecords.length) scopeObj.getGroupWidgetsContextOffline().saveRecords(offlineRecords, sucCallback, errCallback);
                else sucCallback(response)
            }
            onlineSave();
    ...
    removeRecord: function(record, successCallback, errorCallback) {
        try {
            var scopeObj = this;
            if (record.getInfo("options")["access"] == "online") this.getGroupWidgetsContextOnline().removeRecord(record, sucCallback, errCallback);
            else this.getGroupWidgetsContextOffline().removeRecord(record, sucCallback, errCallback);
    ...
    removeRecords: function(records, successCallback, errorCallback) {
        try {
            ...
            function onlineRemove() {
                if (onlineRecords.length) scopeObj.getGroupWidgetsContextOnline().removeRecords(onlineRecords, offlineRemove, errCallback);
                else offlineRemove()
            }

            function offlineRemove(response) {
                if (offlineRecords.length) scopeObj.getGroupWidgetsContextOffline().removeRecords(offlineRecords, sucCallback, errCallback);
                else sucCallback(response)
            }
            onlineRemove();
    ...
    invokeCustomVerb: function(readDataFromForm, successCallback, errorCallback) {
        try {
            this.resetWidgetContexts();
            this.getController().getConfig().changeWidgetListCriteria("customVerb");
            var appFactoryInstance = this.getController().getApplicationContext().getFactorySharedInstance();
            if (readDataFromForm == true) {
                var scopeObj = this;
                var groupWidgetsContext = appFactoryInstance.createGroupWidgetsContextOnline(this.getController().getConfig(), this.getController().getContextData());
                var recordsDataMap = scopeObj.getRecordsDataMap();
                var dataMaplen = recordsDataMap.length;
                if (dataMaplen >= 1) {
                    groupWidgetsContext.customVerbSave(recordsDataMap, sucCallback, errCallback)
                } else {
                    return
                }
                ...
                var scopeObj = this;
                var groupContext = appFactoryInstance.createGroupWidgetsContextOnline(this.getController().getConfig(), this.getController().getContextData());
                var groupWidgets = groupContext.getFetchWidgetList() || [];
                var indx = 0;
                var responseDataMap = {};
                fetchDataForWidgetGroup();
                ...
                function fetchDataForWidgetGroup() {
                    ...
                    groupContext.customVerbFetch(scopeObj.getController().getConfig().getCustomVerb(groupWidgets[indx]), groupWidgets[indx], sucCallback, errCallback);

                    function sucCallback(response) {
                        scopeObj.getController().getConfig().changeWidgetListCriteria();
                        for (var widgetId in response) {
                            if (widgetId === "_raw_response_") {
                                var rawResponse = response[widgetId];
                                responseDataMap["_raw_response_"] = responseDataMap["_raw_response_"] || {};
                    ...
                    function errCallback(error) {
                        this.getController().getConfig().changeWidgetListCriteria();
                        kony.sdk.mvvm.log.error("Error in perform fetch data for widget : " + groupWidgets[indx], error);
                        errorCallback(error)
                    }
                }
            ...
            var exception = this.getController().getApplicationContext().getFactorySharedInstance().createExceptionObject(kony.sdk.mvvm.ExceptionCode.CD_ERROR_CUSTOMVERB, kony.sdk.mvvm.ExceptionCode.MSG_ERROR_CUSTOMVERB, err);
            errorCallback(exception)
        }
    }
});
...
kony.sdk.mvvm.BaseModel = Class({
    ...
    create: function(options, onSuccess, onError) {
        try {
            ...
            kony.sdk.mvvm.log.info("Making SDK create Call");
        ...
        function success(response) {
            kony.sdk.mvvm.log.info("SDK create Success");
        ...
        function error(e) {
            kony.sdk.mvvm.log.error("SDK create Failed " + e);
            var exception = scopeObj.getApplicationContext().getFactorySharedInstance().createExceptionObject(kony.sdk.mvvm.ExceptionCode.CD_ERROR_CREATE, kony.sdk.mvvm.ExceptionCode.MSG_ERROR_CREATE, e);
            onError(exception)
        }
    },
    update: function(options, onSuccess, onError) {
        ...
        try {
            ...
            if (this.getAccessType() === "offline") {
                kony.sdk.mvvm.log.info("Making SDK update Call");
                scopeObj.getObjectService().update(requestOptions, success, error)
            } else {
                kony.sdk.mvvm.log.info("Making SDK partialUpdate Call");
        ...
        function success(response) {
            kony.sdk.mvvm.log.info("SDK update Success");
        ...
        function error(err) {
            kony.sdk.mvvm.log.error("SDK update Failed " + err);
            var exception = scopeObj.getApplicationContext().getFactorySharedInstance().createExceptionObject(kony.sdk.mvvm.ExceptionCode.CD_ERROR_UPDATE, kony.sdk.mvvm.ExceptionCode.MSG_ERROR_UPDATE, err);
            onError(exception)
        }
    },
    ...
    remove: function(options, onSuccess, onError) {
        try {
            ...
            var requestOptions = scopeObj.getRequestOptions(options);
            kony.sdk.mvvm.log.info("Making SDK deleteRecord Call");
        ...
        function success(response) {
            kony.sdk.mvvm.log.info("SDK deleteRecord Success");
        ...
        function error(err) {
            kony.sdk.mvvm.log.error("SDK deleteRecord Failed " + err);
            var exception = scopeObj.getApplicationContext().getFactorySharedInstance().createExceptionObject(kony.sdk.mvvm.ExceptionCode.CD_ERROR_DELETE, kony.sdk.mvvm.ExceptionCode.MSG_ERROR_DELETE, err);
            onError(exception)
        }
    },
    ...
    executeSelectQuery: function(query, succCallback, errCallback) {
        try {
            var self = this;
            kony.sdk.mvvm.log.info("Making SDK executeSelectQuery Call");
            this.getObjectService().executeSelectQuery(query, success, error);

            function success(response) {
                kony.sdk.mvvm.log.info("SDK executeSelectQuery Call Success");
            ...
            function error(err) {
                kony.sdk.mvvm.log.error("SDK executeSelectQuery Call Failed " + err);
    ...
    fetchResponse: function(options, onSuccess, onError) {
        ...
        try {
            ...
            kony.sdk.mvvm.log.info("Making SDK fetch Call");
        ...
        function success(response) {
            kony.sdk.mvvm.log.info("SDK fetch Success");
    ...
    customVerb: function(verbName, options, success, error) {
        ...
        try {
            var self = this;
            var requestOptions = self.getRequestOptions(options);
            kony.sdk.mvvm.log.info("Making SDK custom verb Call");
            ...
            var exception;
            if (e instanceof kony.sdk.mvvm.Exception) exception = self.getApplicationContext().getFactorySharedInstance().createExceptionObject(e.code, e.message, e);
            else exception = self.getApplicationContext().getFactorySharedInstance().createExceptionObject(kony.sdk.mvvm.ExceptionCode.CD_ERROR_CUSTOMVERB, kony.sdk.mvvm.ExceptionCode.MSG_ERROR_CUSTOMVERB, e);
            onError(exception)
        }
        ...
        function onSuccess(response) {
            ...
            kony.sdk.mvvm.Utils.perftimecal("Customverb call in entity controller >>", "CustomVerb call in entity controller done >>", customVerbStartInEntityCtrlTS, customVerbEndInEntityCtrlTS);
            success(response)
        }

        function onError(err) {
            kony.sdk.mvvm.log.error("Error in custom verb call", err);
            var exception = self.getApplicationContext().getFactorySharedInstance().createExceptionObject(kony.sdk.mvvm.ExceptionCode.CD_ERROR_CUSTOMVERB, kony.sdk.mvvm.ExceptionCode.MSG_ERROR_CUSTOMVERB, err);
            error(exception)
        }
    },
...
kony.sdk.mvvm.persistent.GroupWidgetsContextCommon = Class({
    constructor: function(configObject, contextDataObj) {
        ...
        this.addToWidgetList = function(widgetId) {
            if (widgetsList.indexOf(widgetId) == -1) widgetsList.push(widgetId)
        };
        ...
        this.generateWidgetContext = function(widgetId, widgetConfig) {
            ...
            widgetContext["serviceOptions"] = config.getServiceOptions(widgetId);
            ...
            widgetContext["serviceName"] = config.getObjectServiceNameOfContainer(widgetId);
    ...
    constructor: function(configObject, contextDataObj) {
        ...
        this.getORMController = function() {
            if (!ORMController) {
                var appFactoryInstance = kony.sdk.mvvm.KonyApplicationContext.getFactorySharedInstance();
                var INSTANCE = kony.sdk.mvvm.KonyApplicationContext.getAppInstance();
                ORMController = appFactoryInstance.createORMControllerObject(INSTANCE, {
                    access: "offline"
                })
            }
            return ORMController
...
kony.sdk.mvvm.persistent.GroupWidgetsContextOnline = Class({
    ...
    customVerbFetch: function(customVerb, widgetId, success, error) {
        var scopeObj = this;
        var widgetContext = this.getCommonGroupWidgetsContext().getWidgetContext(widgetId);
        var fetchContext = {};
        var dataModel = widgetContext["dataModel"];
        ...
        fetchContext["serviceName"] = widgetContext["serviceName"];
        fetchContext["serviceOptions"] = widgetContext["serviceOptions"];
        fetchContext["customVerb"] = customVerb;
        var requestOptions = widgetContext["requestOptions"];
        fetchContext["requestOptions"] = requestOptions;
        var ORMController = this.getORMController(widgetId);
        var fetchChild = this.isGroupExpand(widgetId);
        ...
        function succCallback(response) {
            ...
            if (response && response["records"]) result[widgetId] = JSON.parse(JSON.stringify(response["records"]));
            scopeObj.updateChildResponse(widgetContext, result[widgetId], result);
            success.call(scopeObj, result)
        }

        function errCallback(err) {
            error.call(scopeObj, err)
        }
    },
    customVerbSave: function(records, success, error) {
        this.getORMController().saveRecords(records, success, error)
    }
});
...
kony.sdk.mvvm.MetadataServiceManagerMF = Class(kony.sdk.mvvm.AppInitServiceMangerInterface, {
    ...
    fetch: function(options, serviceName, successcallback, errorCallback) {
        ...
        kony.sdk.mvvm.log.info("Making SDK metadata Call");
    ...
    fetchForAllObjectServices: function(options, success, error) {
        ...
        function successCbk(response) {
            kony.sdk.mvvm.log.info("SDK metadata Call Success for ObjectService " + objectServicesList[osvIndx]);
...
kony.sdk.mvvm.MetadataStore = Class({
    constructor: function() {
        ...
        this.getObjectServiceName = function(entity) {
            for (each in serviceMetadata) {
                var objsvcMeta = serviceMetadata[each];
                if (objsvcMeta.hasOwnProperty(entity)) return each
            }
        }
    },
...
kony.sdk.mvvm.persistent.ORMControllerMFAPPSuper = Class(kony.sdk.mvvm.persistent.ORMControllerInterface, {
    ...
    saveRecord: function(record, onSuccess, onError) {
        try {
            ...
            var serviceName = record.getInfo("serviceName");
            var options = record.getInfo("options");
            var customVerb = record.getInfo("customVerb");
            var modelObj = this.getApplicationContext().getModel(entityName, serviceName, options);
            ...
            if (customVerb) {
                modelObj.customVerb(customVerb, requestOptions, success, error)
            } else if (operation && operation === kony.sdk.mvvm.OperationType.ADD) {
    ...
    return {
        ...
        fetchByNativeQuery: function(fetchContext, onSuccess, onError) {
            try {
                ...
                var customVerb = fetchContext["customVerb"];
                ...
                requestOptions["dataObject"] = dataObject;
                if (customVerb) modelObj.customVerb(customVerb, requestOptions, success, error);
                else modelObj.fetchResponseWithRecords(requestOptions, success, error);
        ...
        fetchDataMap: function(queryMap, fetchContext, onSuccess, onError) {
            ...
            requestOptions["dataObject"] = dataObject;
            if (customVerb) entityCtrlr.customVerb(customVerb, requestOptions, success, error);
            else entityCtrlr.fetchResponseWithRecords(requestOptions, success, error);
...
kony.sdk.mvvm.SyncManagerMF = Class(kony.sdk.mvvm.AppInitServiceMangerInterface, {
    ...
    sync: function(successcallback, errorCallback, syncConfig) {
        ...
        function initSuccess() {
            kony.sdk.mvvm.log.info("SDK syncInit Success");
            scopeObj.syncData(successcallback, errorCallback, syncConfig)
        }

        function initError() {
            kony.sdk.mvvm.log.error("SDK syncInit Failed");
            errorCallback()
        }
    },
    syncInit: function(success, error) {
        kony.sdk.mvvm.log.info("Getting SDK SyncService");
        var syncObj = kony.sdk.getCurrentInstance().getSyncService();
        kony.sdk.mvvm.log.info("Making SDK syncInit Call");
    ...
    reset: function(successcallback, errorCallback) {
        ...
        function resetSuccess() {
            kony.sdk.mvvm.log.info("SDK resetSync Success");
            kony.sdk.mvvm.KonyApplicationContext.dismissLoadingScreen();
            successcallback()
        }

        function resetError() {
            kony.sdk.mvvm.log.error("SDK resetSync Failed");
            errorCallback()
        }
    },
    rollback: function(rollbackSuccess, rollbackError) {
        kony.sdk.mvvm.log.info("Getting SDK SyncService");
        var syncObj = kony.sdk.getCurrentInstance().getSyncService();
        kony.sdk.mvvm.log.info("Making SDK syncRollback Call");
    ...
    startSyncForScope: function(syncscopeSuccesscallback, syncscopeErrorcallback, isMetadata, config) {
        ...
        kony.sdk.mvvm.log.info("Getting SDK SyncService");
        var syncObj = kony.sdk.getCurrentInstance().getSyncService();
        kony.sdk.mvvm.log.info("Starting SDK syncSession");
        syncObj.startSession(config);

        function syncSuccess() {
            kony.sdk.mvvm.log.info("SDK sync Success");
            kony.sdk.mvvm.onsyncsuccessCallback();
            syncscopeSuccesscallback()
        }

        function syncError(err) {
            kony.sdk.mvvm.log.error("SDK sync Failed " + err);
...
function InitSync() {
    ...
    function error(err) {
        kony.sdk.mvvm.log.error("SDK syncInit Failed " + err);
...
function startSync() {
    ...
    function success() {
        kony.sdk.mvvm.log.info("Sync succeded, waiting for progress to complete");
...
function resetSync() {
    kony.sdk.mvvm.log.info("Getting SDK SyncService");
    var syncObj = kony.sdk.getCurrentInstance().getSyncService();
    kony.sdk.mvvm.log.info("Making SDK syncReset Call");
    ...
    function error(err) {
        kony.sdk.mvvm.log.error("SDK resetSync Failed " + err);
...
function rollbackSync() {
    ...
    function success() {
        kony.sdk.mvvm.log.info("SDK syncRollback Success");
        alert("Rollback success")
    }

    function error(err) {
        kony.sdk.mvvm.log.error("SDK syncRollback Failed " + err);
...
function stopSync() {
    kony.sdk.mvvm.log.info("Getting SDK SyncService");
    var syncObj = kony.sdk.getCurrentInstance().getSyncService();
    kony.sdk.mvvm.log.info("Making SDK syncStopSession");
    syncObj.stopSession(success);

    function success() {
        hidePopup();
        kony.sdk.mvvm.log.info("SDK Sync stopped")
    }
}
sync_status = {
    NOT_YET_STARTED: 0,
